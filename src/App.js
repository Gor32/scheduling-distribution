  ...
  render () {
    try {
      ...
      return (
        <Router>
          <div>
            <div className="w3-sidebar w3-bar-block w3-animate-left" style={{display: 'none', 'zIndex': 5}}
                 id="mySidebar">
              <button className="w3-bar-item w3-button w3-large" onClick={this.w3_close}>Փակել &times;</button>
              <Link to="/" className="w3-bar-item w3-button">Սկիզբ </Link>
      ...
      return (
        <div>
          <span>
            Սխալ արժեքների ներմուծում է հայտնաբերվել
          </span>
        </div>
      )
    }
