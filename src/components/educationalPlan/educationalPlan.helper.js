...
export function calculateSemestersWithAdditionalData (semester, newItem, column) {
  return calculateSemesters(semester, newItem, column, true)
}

function calculateSemesters (semester, newItem, column, isAdditionalData) {
